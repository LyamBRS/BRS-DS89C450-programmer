...
namespace BRS
{
    ...
    {
        /// <summary>
        /// The colour of the actual background of your button in specific conditions
        /// </summary>
        public struct background
        {
            /// <summary> Color displayed when the mouse hovers above the control </summary>
            public Color Hovering;
            /// <summary> Color displayed when the mouse is pressing in the control </summary>
            public Color Pressing;
            /// <summary> Color displayed by default </summary>
            public Color Default;
        }
        /// <summary>
        /// The colour of the buttons generated by WinForm (FlatStyle.Mouse...)
        /// </summary>
        public struct flatstyle
        {
            /// <summary> FlatStyle border colours </summary>
            public Color Border;
            /// <summary> FlatStyle mouse hover colour (Set to background colour for animated buttons) </summary>
            public Color Hovering;
            /// <summary> FlatStyle mouse pressing colour (Set to background colour for animated buttons) </summary>
            public Color Pressing;
        }
        /// <summary>
        /// The colour of the actual background of your button in specific conditions
        ...
        /// The colour of the buttons generated by WinForm (FlatStyle.Mouse...)
        /// </summary>
        public flatstyle FlatStyle = new flatstyle();

        //#############################################################//        
        /// <summary>
        /// Set all colours to empty color by default
        /// </summary>
        //#############################################################// 
        public ButtonColors()
        {
            Background.Hovering = Color.Empty;
            Background.Pressing = Color.Empty;
            Background.Default = Color.Empty;
            FlatStyle.Hovering = Color.Empty;
            FlatStyle.Pressing = Color.Empty;
        }
        //#############################################################//
        /// <summary>
        /// Sets BackColour and FlatStyle color to their own universal
        /// values. This is used when attempting to cancel WinForms hovering
        /// colours, so only animations are used.
        /// </summary>
        /// <param name="buttonFlatStyle">Color that all flatstyle attributes will be set to</param>
        /// <param name="buttonBackground">Color that all backColors will be set to.</param>
        //#############################################################// 
        public ButtonColors(Color buttonFlatStyle, Color buttonBackground)
        {
            Background.Hovering = buttonBackground;
            Background.Pressing = buttonBackground;
            Background.Default = buttonBackground;
            FlatStyle.Hovering = buttonFlatStyle;
            FlatStyle.Pressing = buttonFlatStyle;
        }
        //#############################################################//
        /// <summary>
        /// Allows to define a global flatStyle color, and individually
        /// define each of the backgrounds colours to be used.
        /// Useful for quick define of animated buttons highlighted colours
        /// </summary>
        /// <param name="buttonFlatStyle"></param>
        /// <param name="BG_Default"></param>
        /// <param name="BG_Hovering"></param>
        /// <param name="BG_Pressing"></param>
        //#############################################################// 
        public ButtonColors(Color buttonFlatStyle, Color BG_Default, Color BG_Hovering, Color BG_Pressing)
        {
            Background.Hovering = BG_Hovering;
            Background.Pressing = BG_Pressing;
    ...
    public partial class TriStateButton : Button
    {
        ...
        //#############################################################//
        /// <summary>
        /// Sets the 3 colour of the button. Hovering and Pressing is back colours.
        /// this is used because regular mouse event colours cant be lerped.
        /// MouseEventColors is the actual mouse event colours, which should
        /// be set to the background colour behind your button.
        /// </summary>
        /// <param name="MouseEventColors"> Windows handled colour changes. Put your form's back colour for best results</param>
        /// <param name="Hovering">Colour wanted when cursor is over the button. ACTUALLY BACKCOLOR</param>
        /// <param name="Pressing">Colour wanted when cursor is pressing the button. ACTUALLY BACKCOLOR</param>
        //#############################################################//
        public void SetAllColors(Color MouseEventColors, Color Hovering, Color Pressing)
        {
            BRS.Debug.Header(true);
            BRS.Debug.Comment("Setting colours for this button");

            PressedColor = Pressing;
            HoveringColor = Hovering;
            FormButton.FlatAppearance.MouseOverBackColor = MouseEventColors;
            FormButton.FlatAppearance.MouseDownBackColor = MouseEventColors;
        ...
        //#############################################################//
        /// <summary>
        /// Allows an instance of buttonColors to be passed to quickly
        /// set all the buttons colours to a pre-defined ones.
        /// </summary>
        /// <param name="colors"></param>
        //#############################################################// 
        public void SetAllColors(ButtonColors colors)
        {
            BRS.Debug.Header(true);
            BRS.Debug.Comment("Setting colours for this button");

            PressedColor = colors.Background.Pressing;
            HoveringColor = colors.Background.Hovering;
            FormButton.FlatAppearance.MouseOverBackColor = colors.FlatStyle.Hovering;
            FormButton.FlatAppearance.MouseDownBackColor = colors.FlatStyle.Pressing;
